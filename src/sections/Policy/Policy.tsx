      ...
      <div className='container'>
        {policy && (
          <div>
            ...
            <div
              className='prose-p:text-textBody prose-ul:text-textBody prose-h2:mb-4 prose-h2:font-inter prose-h2:text-[14px] prose-h2:font-bold prose-h2:uppercase prose-h2:leading-[1.15] prose-h2:text-blueDefault prose-p:mb-8 prose-p:font-inter prose-p:text-[14px] prose-p:font-light prose-p:leading-[1.35] prose-p:tracking-[-0.28px] prose-a:text-[14px] prose-a:font-light prose-a:leading-[1.35] prose-a:tracking-[-0.28px] prose-ul:mt-[-32px] prose-ul:list-disc prose-ul:pl-6 prose-ul:font-inter prose-ul:text-[14px] prose-ul:font-light prose-ul:leading-[1.35] prose-ul:tracking-[-0.28px] md:prose-h2:text-[16px] md:prose-h2:leading-[1.30] md:prose-p:mb-10 md:prose-p:text-[16px] md:prose-p:tracking-[-0.32px] md:prose-a:text-[16px] md:prose-a:tracking-[-0.32px] md:prose-ul:mt-[-40px] md:prose-ul:text-[16px] md:prose-ul:tracking-[-0.32px] xl:prose-h2:mb-6 xl:prose-h2:text-[20px] xl:prose-p:text-[18px] xl:prose-p:tracking-[-0.36px] xl:prose-a:text-[18px] xl:prose-a:tracking-[-0.36px] xl:prose-ul:text-[18px] xl:prose-ul:tracking-[-0.36px]'
