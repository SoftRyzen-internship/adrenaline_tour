...
const linkButtonStyle = {
  main: 'focus:bg-accentDarkOrange md:py-[14px] gap-4 bg-accentDefaultOrange px-7 py-4 font-unbounded text-sm text-white transition-colors hover:bg-accentDarkOrange  md:text-base font-medium leading-[1.5]',
  secondary:
